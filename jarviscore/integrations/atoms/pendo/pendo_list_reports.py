...
def pendo_list_reports(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, data, status, err = _pn_request("get", root + "/report", auth_info, timeout=timeout, verify_ssl=verify_ssl)
        if err:

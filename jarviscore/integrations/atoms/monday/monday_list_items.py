...
def monday_list_items(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _md_items_page(base, headers, board_id, limit, None, timeout, verify_ssl)

...
async def monday_get_board(board_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _md_gql(base, headers, q, {'ids': [str(board_id)]}, timeout, verify_ssl)

...
def monday_list_boards(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        while len(records) < cap and page <= 50:
            ...
            resp = _md_gql(base, headers, q, {"limit": min(cap - len(records), 100), "page": page}, timeout, verify_ssl)

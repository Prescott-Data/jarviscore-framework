...
def monday_get_item(auth_info: dict, item_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _md_gql(base, headers, q, {"ids": [str(item_id)]}, timeout, verify_ssl)

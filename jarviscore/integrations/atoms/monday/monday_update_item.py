...
def monday_update_item(auth_info: dict, item_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _md_gql(base, headers, q, {"board_id": str(board_id), "item_id": str(item_id), "column_values": json.dumps(col_vals)}, timeout, verify_ssl)

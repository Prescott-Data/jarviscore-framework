...
def activecampaign_get_contact(auth_info: dict, contact_id: str, account: Optional[str] = None, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
...
# GET /contacts/{id} — https://developers.activecampaign.com/reference/get-contact

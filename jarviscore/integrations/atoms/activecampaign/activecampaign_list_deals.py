...
def activecampaign_list_deals(auth_info: dict, account: Optional[str] = None, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
...
# GET /deals — https://developers.activecampaign.com/reference/list-all-deals

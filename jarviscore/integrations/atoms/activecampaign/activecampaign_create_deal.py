...
def activecampaign_create_deal(auth_info: dict, payload: Dict[str, Any], account: Optional[str] = None, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
...
# POST /deals — https://developers.activecampaign.com/reference/create-a-deal-new

...
async def activecampaign_list_contacts(account: Optional[str]=None, limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        while len(records) < cap:
            ...
            resp = await nexus_call('GET', f'{api_root}/contacts', headers=headers, params={'limit': page_size, 'offset': offset})

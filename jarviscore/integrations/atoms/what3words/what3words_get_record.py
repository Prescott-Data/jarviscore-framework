...
async def what3words_get_record(lat: str, lng: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        if not lat or not lng:
            return _w3w_dataset([], 400, 'lat and lng are required')
        resp = await nexus_call('GET', f'{root}/convert-to-3wa', params={'coordinates': f'{lat},{lng}', 'key': key})

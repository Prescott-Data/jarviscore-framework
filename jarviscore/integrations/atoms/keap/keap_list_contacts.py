...
def keap_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List Keap contacts. Official: https://developer.keap.com/docs/restv2/"""
    try:
        ...
        records, status, message = _kp_paginate(f"{api}/contacts", headers, limit, timeout, verify_ssl)

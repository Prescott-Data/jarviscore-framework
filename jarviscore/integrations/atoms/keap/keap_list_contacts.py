...
async def keap_list_contacts(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, message) = await _kp_paginate(f'{api}/contacts', headers, limit, timeout, verify_ssl)

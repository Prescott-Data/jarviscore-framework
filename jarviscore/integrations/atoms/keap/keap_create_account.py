...
def keap_create_account(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create Keap account. Official: https://developer.keap.com/docs/restv2/"""
    try:
        ...
        resp = _kp_post(f"{api}/companies", headers, payload, timeout, verify_ssl)

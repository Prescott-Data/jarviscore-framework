...
async def keap_update_account(record_id: str, payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _kp_patch(f'{api}/companies/{record_id}', headers, payload, timeout, verify_ssl)
...
async def _kp_patch(url, headers, body, timeout, verify_ssl):

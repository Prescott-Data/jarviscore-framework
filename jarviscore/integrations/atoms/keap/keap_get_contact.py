...
def keap_get_contact(auth_info: dict, record_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get Keap contact by ID. Official: https://developer.keap.com/docs/restv2/"""
    try:
        ...
        resp = _kp_get(f"{api}/contacts/{record_id}", headers, None, timeout, verify_ssl)

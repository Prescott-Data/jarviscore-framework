...
def keap_create_contact(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create Keap contact. Official: https://developer.keap.com/docs/restv2/"""
    try:
        ...
        resp = _kp_post(f"{api}/contacts", headers, payload, timeout, verify_ssl)

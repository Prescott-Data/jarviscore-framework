...
def keap_delete_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _kp_delete(f"{api}/companies/{account_id}", headers, timeout, verify_ssl)

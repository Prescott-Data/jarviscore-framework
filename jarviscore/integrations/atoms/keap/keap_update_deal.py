...
def keap_update_deal(auth_info: dict, record_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Update Keap deal. Official: https://developer.keap.com/docs/restv2/"""
    try:
        ...
        resp = _kp_patch(f"{api}/opportunities/{record_id}", headers, payload, timeout, verify_ssl)

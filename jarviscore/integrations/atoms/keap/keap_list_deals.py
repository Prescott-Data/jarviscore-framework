...
def keap_list_deals(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List Keap deals. Official: https://developer.keap.com/docs/restv2/"""
    try:
        ...
        records, status, message = _kp_paginate(f"{api}/opportunities", headers, limit, timeout, verify_ssl)

...
async def keap_get_deal(record_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _kp_get(f'{api}/opportunities/{record_id}', headers, None, timeout, verify_ssl)

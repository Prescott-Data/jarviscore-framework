...
def keap_get_account(auth_info: dict, record_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _kp_get(f"{api}/companies/{record_id}", headers, None, timeout, verify_ssl)

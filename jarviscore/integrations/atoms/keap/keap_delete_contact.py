...
def keap_delete_contact(auth_info: dict, contact_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _kp_delete(f"{api}/contacts/{contact_id}", headers, timeout, verify_ssl)

...
def keap_update_contact(auth_info: dict, record_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _kp_patch(f"{api}/contacts/{record_id}", headers, payload, timeout, verify_ssl)

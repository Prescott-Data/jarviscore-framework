...
def simplepay_create_customer(auth_info: dict, client_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/clients/{cid}/employees", headers=headers, json=body, timeout=timeout, verify=verify_ssl)

...
def simplepay_update_order(auth_info: dict, client_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        body = payload if isinstance(payload.get("entities"), list) else {"entities": [payload]}

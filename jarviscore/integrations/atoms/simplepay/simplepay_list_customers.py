...
def simplepay_list_customers(auth_info: dict, client_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """SimplePay: list employees (customers). Official: https://www.simplepay.co.za/api-docs/"""
    try:
        ...
        records = _sp_unwrap_items(data, "employee")[:cap]

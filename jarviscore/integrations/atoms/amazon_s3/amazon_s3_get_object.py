...
async def amazon_s3_get_object(bucket: str, object_id: str, destination_path: Optional[str]=None, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _s3_request('GET', url, region, access_key, secret_key, session_token, timeout=timeout, verify_ssl=verify_ssl)

...
def beanstalk_list_projects(auth_info: dict, account: Optional[str] = None, timeout: int = 30, verify_ssl: bool = True, limit: int = 25, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _beanstalk_paginate(api_root, "/repositories.json", headers, basic, limit, timeout, verify_ssl)

...
async def beanstalk_get_project(project_id: str, account: Optional[str]=None, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _beanstalk_get(api_root, f'/repositories/{project_id}.json', headers, basic, None, timeout, verify_ssl)

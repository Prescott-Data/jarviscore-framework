...
async def beanstalk_get_build(build_id: str, account: Optional[str]=None, timeout: int=30, verify_ssl: bool=True, repository_id: Optional[str]=None, base_url: str=None) -> dict:

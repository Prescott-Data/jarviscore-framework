...
def backblaze_b2_get_file(auth_info: dict, file_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _b2_post(session["api_url"], "/b2api/v4/b2_get_file_info", session["auth_token"], {"fileId": file_id}, timeout, verify_ssl)
...
# Backblaze B2 Native API — https://www.backblaze.com/b2/docs/b2_get_file_info.html

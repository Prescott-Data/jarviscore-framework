...
async def backblaze_b2_list_folders(bucket_id: Optional[str]=None, bucket_name: Optional[str]=None, prefix: str='', limit: int=100, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:

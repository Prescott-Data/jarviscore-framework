...
def livechat_search_records(auth_info: dict, query: str, limit: int = 25, page_id: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, aerr = _lc_post(base, "list_archives", body, auth_info, timeout, verify_ssl)
        if aerr:

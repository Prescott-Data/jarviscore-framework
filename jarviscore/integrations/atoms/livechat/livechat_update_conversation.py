...
def livechat_update_conversation(auth_info: dict, conversation_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, aerr = _lc_post(base, "update_chat_properties", body, auth_info, timeout, verify_ssl)
        if aerr:

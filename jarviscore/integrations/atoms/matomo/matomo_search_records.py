...
def matomo_search_records(auth_info: dict, id_site: str, query: str, period: str = "day", date: str = "today", limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
...
# Matomo Actions / Site Search API — Official docs:
# Reporting API https://developer.matomo.org/api-reference/reporting-api#module_actions

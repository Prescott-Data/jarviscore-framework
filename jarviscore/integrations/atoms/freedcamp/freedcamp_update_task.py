...
def freedcamp_update_task(auth_info: dict, task_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{api}/tasks/{task_id}", headers=headers, params=auth, json=payload, timeout=timeout, verify=verify_ssl)

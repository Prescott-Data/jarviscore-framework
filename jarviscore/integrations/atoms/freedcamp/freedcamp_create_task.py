...
def freedcamp_create_task(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{api}/tasks", headers=headers, params=auth, json=payload, timeout=timeout, verify=verify_ssl)

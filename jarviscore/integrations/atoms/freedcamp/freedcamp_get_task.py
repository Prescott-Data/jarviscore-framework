...
async def freedcamp_get_task(task_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{api}/tasks/{task_id}', headers=headers, params=auth)

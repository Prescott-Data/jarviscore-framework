...
def freedcamp_get_project(auth_info: dict, project_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get project by id. Official: https://freedcamp.com/help_/tutorials/wiki/wiki_public/view/DFaab#/projects"""
    try:
        ...
        resp = requests.get(f"{api}/projects/{project_id}", headers=headers, params=auth, timeout=timeout, verify=verify_ssl)

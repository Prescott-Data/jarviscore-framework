...
async def freedcamp_get_project(project_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{api}/projects/{project_id}', headers=headers, params=auth)

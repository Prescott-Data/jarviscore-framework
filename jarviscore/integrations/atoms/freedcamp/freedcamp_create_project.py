...
def freedcamp_create_project(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create project (POST JSON body). Official: https://freedcamp.com/help_/tutorials/wiki/wiki_public/view/DFaab#/projects"""
    try:
        ...
        resp = requests.post(f"{api}/projects", headers=headers, params=auth, json=payload, timeout=timeout, verify=verify_ssl)

...
async def phabricator_get_build(build_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp, result, status, msg = await _ph_conduit('harbormaster.build.search', params, base_url, timeout, verify_ssl)
        if status >= 400:

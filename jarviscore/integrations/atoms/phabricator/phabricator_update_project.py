...
def phabricator_update_project(auth_info: dict, project_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, result, status, msg = _ph_conduit("project.edit", params, base_url, auth_info, timeout, verify_ssl)
        if status >= 400:

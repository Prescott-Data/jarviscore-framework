...
def _ph_payload_transactions(payload, mapping):
    ...
    return (tx, None)
_PLAN_TX = {'name': 'name', 'behavior_hold_drafts': 'behavior.hold-drafts', 'behavior_arc_land': 'behavior.arc-land', 'behavior_buildable': 'behavior.buildable', 'behavior_restartable': 'behavior.restartable', 'behavior_runnable': 'behavior.runnable'}

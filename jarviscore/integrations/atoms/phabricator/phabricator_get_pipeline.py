...
def phabricator_get_pipeline(auth_info: dict, pipeline_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, result, status, msg = _ph_conduit("harbormaster.buildplan.search", params, base_url, auth_info, timeout, verify_ssl)
        if status >= 400:

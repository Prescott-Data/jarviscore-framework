...
def telegram_get_update(auth_info: dict, update_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/getUpdates", params={"offset": update_id, "limit": 1}, timeout=timeout, verify=verify_ssl)

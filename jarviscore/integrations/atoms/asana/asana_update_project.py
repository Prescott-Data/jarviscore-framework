...
def asana_update_project(auth_info: dict, project_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
...
# PUT /projects/{project_gid} — https://developers.asana.com/reference/updateproject

...
_TYPEAHEAD_RESOURCES = {'task', 'project', 'user', 'tag', 'team', 'portfolio', 'goal', 'custom_field', 'project_template'}

async def asana_search_records(query: str, workspace: Optional[str]=None, resource_type: str='task', limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{api_root}/workspaces/{workspace_gid}/typeahead', headers=headers, params=params)

...
def asana_create_project(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        return _asana_provision(records, status, "ok", _asana_provision_ids(body))
    except Exception as e:
        return _asana_provision([], 500, str(e))


# POST /projects — https://developers.asana.com/reference/createproject

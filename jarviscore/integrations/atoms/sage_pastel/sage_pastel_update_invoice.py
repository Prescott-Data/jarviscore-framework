...
def sage_pastel_update_invoice(auth_info: dict, invoice_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, body, status, msg = _pt_save("TaxInvoice", base_url, auth_info, body_payload, timeout, verify_ssl, extra)
        if status >= 400:

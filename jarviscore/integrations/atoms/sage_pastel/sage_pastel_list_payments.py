...
async def sage_pastel_list_payments(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    """List customer receipts. Official: https://accounting.sageone.co.za/api/2.0.0/Help"""
    try:
        records, status, msg = await _pt_list('CustomerReceipt', base_url, limit, timeout, verify_ssl)

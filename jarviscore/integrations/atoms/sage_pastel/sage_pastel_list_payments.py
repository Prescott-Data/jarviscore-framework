...
def sage_pastel_list_payments(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List customer receipts. Official: https://accounting.sageone.co.za/api/2.0.0/Help"""
    try:
        records, status, msg = _pt_list("CustomerReceipt", base_url, auth_info, limit, timeout, verify_ssl)

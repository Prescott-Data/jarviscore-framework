...
async def twitter_ads_list_campaigns(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        if err:
            return _xa_dataset([], 400, err)
        resp = await nexus_call('GET', f'{root}/accounts/{aid}/campaigns', headers=headers, params={'count': limit})

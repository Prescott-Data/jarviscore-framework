...
# Kissmetrics REST API v3 — https://support.kissmetrics.io/reference/fetch-events
KM_API = "https://query.kissmetrics.io/v3"


def kissmetrics_list_events(auth_info: dict, product_id: str, limit: int = 25, offset: int = 0, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List Kissmetrics events for a product (GET /v3/products/{product_id}/events). Official: https://support.kissmetrics.io/reference/fetch-events"""
    try:
        ...
        resp = _km_get(f"{api}/products/{pid}/events", headers, basic, params, timeout, verify_ssl)

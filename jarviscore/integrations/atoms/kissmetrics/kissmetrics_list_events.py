...
async def kissmetrics_list_events(product_id: str, limit: int=25, offset: int=0, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _km_get(f'{api}/products/{pid}/events', headers, basic, params, timeout, verify_ssl)

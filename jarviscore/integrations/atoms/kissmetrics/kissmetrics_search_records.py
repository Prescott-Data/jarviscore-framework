...
def kissmetrics_search_records(auth_info: dict, query: str, product_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        needle = query.lower()
        matched = []
        for item in _km_records(resp.json() if resp.text else {}):

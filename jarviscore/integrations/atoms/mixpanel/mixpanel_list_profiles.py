...
def mixpanel_list_profiles(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        while len(records) < cap and page < 50:
            ...
            if page == 0:
                ...
                form["page"] = str(page)
            data, status, msg = _mp_engage_query(base_url, auth_info, "", form, timeout, verify_ssl)

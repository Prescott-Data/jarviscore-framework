...
def mixpanel_get_event(auth_info: dict, event_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        if not from_date or not to_date:
            ...
            from_date = from_date or (today - timedelta(days=31)).isoformat()
        where = f'properties["$insert_id"] == "{event_id}"'
        params = {"project_id": pid, "from_date": from_date, "to_date": to_date, "where": where, "limit": 100}

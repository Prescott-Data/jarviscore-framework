...
def mixpanel_list_events(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/events/names", headers=headers, params=params, timeout=timeout, verify=verify_ssl)

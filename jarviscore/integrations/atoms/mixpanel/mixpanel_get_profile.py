...
def mixpanel_get_profile(auth_info: dict, profile_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        data, status, msg = _mp_engage_query(base_url, auth_info, "", {"distinct_id": str(profile_id)}, timeout, verify_ssl)

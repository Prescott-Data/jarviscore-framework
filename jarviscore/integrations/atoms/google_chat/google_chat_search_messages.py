...
def google_chat_search_messages(auth_info: dict, space_name: str, filter_expr: str, max_results: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _chat_page(url, headers, {"filter": filter_expr}, "messages", max_results, timeout, verify_ssl)

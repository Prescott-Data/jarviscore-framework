...
def google_chat_search_conversations(auth_info: dict, query: str, use_admin_access: bool = False, max_results: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _chat_page(url, headers, params, "spaces", max_results, timeout, verify_ssl)

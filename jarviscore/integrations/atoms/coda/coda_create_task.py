...
def coda_create_task(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        doc_id, table_id, err = _coda_row_context(auth_info, payload)
        if err:
        ...
        resp = _coda_post(f"{api}/docs/{doc_id}/tables/{table_id}/rows", headers, body, timeout, verify_ssl)

...
def coda_get_task(auth_info: dict, task_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        doc_id, table_id, err = _coda_row_context(auth_info)
        if err:
        ...
        resp = _coda_get(f"{api}/docs/{doc_id}/tables/{table_id}/rows/{task_id}", headers, None, timeout, verify_ssl)

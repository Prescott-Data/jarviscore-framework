...
def coda_create_project(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _coda_post(f"{api}/docs", headers, payload, timeout, verify_ssl)

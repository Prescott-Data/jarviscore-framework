...
def coda_update_task(auth_info: dict, task_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _coda_put(f"{api}/docs/{doc_id}/tables/{table_id}/rows/{task_id}", headers, body, timeout, verify_ssl)

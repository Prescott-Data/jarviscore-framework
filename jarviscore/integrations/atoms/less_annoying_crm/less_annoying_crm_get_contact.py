...
def less_annoying_crm_get_contact(auth_info: dict, contact_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _lacrm_call(base, headers, "GetContact", {"ContactId": str(contact_id)}, timeout, verify_ssl)

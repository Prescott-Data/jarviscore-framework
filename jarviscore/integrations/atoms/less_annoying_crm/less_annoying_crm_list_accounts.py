...
def less_annoying_crm_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _lacrm_paginate(base, headers, "GetContacts", {"RecordTypeFilter": "Companies"}, limit, timeout, verify_ssl)

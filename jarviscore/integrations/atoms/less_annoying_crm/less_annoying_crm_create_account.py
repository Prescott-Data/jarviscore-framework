...
def less_annoying_crm_create_account(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        if "Company Name" not in params and params.get("name"):
            params["Company Name"] = params.pop("name")

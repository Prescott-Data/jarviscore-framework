...
def less_annoying_crm_delete_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Delete a account in less_annoying_crm (DeleteContact). Official: https://account.lessannoyingcrm.com/api_docs/v2/Core_Functions/Contacts"""
    try:
        if not account_id:
        ...
        resp = _lacrm_call(base, headers, "DeleteContact", {"ContactId": str(account_id)}, timeout, verify_ssl)

...
ATOM_POLICY = {"effect": "destructive", "approval": "required", "idempotency_fields": ["contact_id"], "consequence": "Deletes the Less Annoying CRM contact."}
LACRM_API = 'https://api.lessannoyingcrm.com/v2'

async def less_annoying_crm_delete_contact(contact_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _lacrm_call(base, headers, 'DeleteContact', {'ContactId': str(contact_id)}, timeout, verify_ssl)

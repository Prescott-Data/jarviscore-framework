...
def less_annoying_crm_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Search contacts via GetContacts SearchTerms. Official: https://account.lessannoyingcrm.com/api_docs/v2/Core_Functions/Search"""
    try:
        ...
        records, status, msg = _lacrm_paginate(base, headers, "GetContacts", {"SearchTerms": str(query)}, limit, timeout, verify_ssl)

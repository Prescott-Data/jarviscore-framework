...
def less_annoying_crm_get_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get company via GetContact. Official: https://account.lessannoyingcrm.com/api_docs/v2/Core_Functions/Contacts"""
    try:
        ...
        resp = _lacrm_call(base, headers, "GetContact", {"ContactId": str(account_id)}, timeout, verify_ssl)

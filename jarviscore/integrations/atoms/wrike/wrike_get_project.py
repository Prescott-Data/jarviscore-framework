...
def wrike_get_project(auth_info: dict, project_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + "/folders/" + str(project_id), headers=headers, timeout=timeout, verify=verify_ssl)

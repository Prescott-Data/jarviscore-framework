...
def wrike_list_tasks(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """wrike REST: list tasks. Official: https://developers.wrike.com/api/v4/"""
    try:
        ...
        resp = requests.get(root + "/tasks", headers=headers, params={"limit": limit}, timeout=timeout, verify=verify_ssl)

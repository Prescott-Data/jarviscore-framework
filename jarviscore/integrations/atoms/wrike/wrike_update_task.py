...
async def wrike_update_task(task_id: str, name: str='', limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('PUT', root + '/tasks/' + str(task_id), headers=headers, data={'title': name} if name else {})

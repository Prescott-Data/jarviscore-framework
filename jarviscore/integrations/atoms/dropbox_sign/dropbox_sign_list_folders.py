...
async def dropbox_sign_list_folders(limit: int=20, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        while len(records) < cap:
            ...
            resp = await nexus_call('GET', f'{api}/template/list', headers=headers, params=params)

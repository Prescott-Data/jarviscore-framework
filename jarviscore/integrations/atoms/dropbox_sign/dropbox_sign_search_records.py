...
# Dropbox Sign API v3 — https://developers.hellosign.com/api/reference/signature_request_list
SIGN_API = "https://api.hellosign.com/v3"


def dropbox_sign_search_records(auth_info: dict, query: str, limit: int = 20, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Search signature requests via list query param. Official: https://developers.hellosign.com/api/signature-request/list"""
    try:
        if not query:
        ...
        while len(records) < cap:
            ...
            batch = data.get("signature_requests") or []

...
def paystack_list_customers(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List customers with page/perPage pagination. Official: https://paystack.com/docs/api/customer/#list-customers"""
    try:

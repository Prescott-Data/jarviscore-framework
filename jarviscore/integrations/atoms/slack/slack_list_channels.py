async def slack_list_channels(exclude_archived: bool=True, limit: int=200) -> list:
    """List channels via the slack API."""
    ...
    while True:
        ...
        resp = await _get('/conversations.list', params=params)
        if not resp.get('ok'):

...
def infobip_update_conversation(auth_info: dict, conversation_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _ib_put(f"{api}/ccaas/1/conversations/{conversation_id}", headers, payload, timeout, verify_ssl)

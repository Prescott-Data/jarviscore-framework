...
def infobip_create_conversation(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _ib_post(f"{api}/ccaas/1/conversations", headers, payload, timeout, verify_ssl)

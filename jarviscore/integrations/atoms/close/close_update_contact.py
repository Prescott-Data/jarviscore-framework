...
def close_update_contact(auth_info: dict, contact_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _close_put_json(f"{api}/contact/{contact_id}/", headers, basic, payload, timeout, verify_ssl)

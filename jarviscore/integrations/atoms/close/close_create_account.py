...
async def close_create_account(payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _close_post_json(f'{api}/lead/', headers, basic, payload, timeout, verify_ssl)

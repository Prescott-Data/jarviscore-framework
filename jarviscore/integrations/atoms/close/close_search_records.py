...
def close_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _close_post_json(f"{api}/data/search/", headers, basic, body, timeout, verify_ssl)

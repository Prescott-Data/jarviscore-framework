...
async def close_list_deals(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        records, status, message = await _close_paginate(f'{api}/opportunity/', headers, basic, limit, timeout, verify_ssl)

...
def freshsales_create_deal(auth_info: dict, fields: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        url = f"{api}/deals"
        resp = requests.post(url, headers=headers, json={"deal": fields}, timeout=timeout, verify=verify_ssl)
        ...
        return {
            ...
            "status": status,
            "message": "ok",
            "provision_ids": _fs_provision_id(data, "deal"),
        }

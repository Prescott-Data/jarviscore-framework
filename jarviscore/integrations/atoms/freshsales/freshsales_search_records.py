...
async def freshsales_search_records(query: str, include: str='contact,sales_account,deal', limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{api}/search', headers=headers, params=params)

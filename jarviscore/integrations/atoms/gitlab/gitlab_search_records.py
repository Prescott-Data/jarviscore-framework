...
def gitlab_search_records(auth_info: dict, search: str, scope: str = "issues", max_results: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _gl_paginate_list(
            ...
            timeout,
            verify_ssl,
            params={"scope": scope or "issues", "search": search},
        )

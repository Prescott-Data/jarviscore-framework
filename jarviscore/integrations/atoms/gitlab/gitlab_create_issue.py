...
def gitlab_create_issue(auth_info: dict, project_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(
            f"{api}/projects/{pid}/issues", headers=headers, json=payload, timeout=timeout, verify=verify_ssl
        )

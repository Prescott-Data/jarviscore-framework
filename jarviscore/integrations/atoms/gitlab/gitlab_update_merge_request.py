...
def gitlab_update_merge_request(auth_info: dict, project_id: str, merge_request_iid: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(
            f"{api}/projects/{pid}/merge_requests/{iid}", headers=headers, json=payload, timeout=timeout, verify=verify_ssl
        )

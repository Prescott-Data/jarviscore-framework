...
def gitlab_update_project(auth_info: dict, project_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(f"{api}/projects/{pid}", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)
        ...
        return _gl_provision_response(data, status, id_keys=("id", "path_with_namespace"))

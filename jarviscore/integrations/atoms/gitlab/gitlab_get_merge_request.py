...
def gitlab_get_merge_request(auth_info: dict, project_id: str, merge_request_iid: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _gl_get_entity(
            f"{api}/projects/{pid}/merge_requests/{iid}", headers, timeout, verify_ssl
        )

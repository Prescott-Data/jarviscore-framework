...
def gitlab_list_projects(auth_info: dict, max_results: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _gl_paginate_list(
            f"{api}/projects", headers, max_results, timeout, verify_ssl
        )

...
async def gitlab_get_project(project_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        records, status, msg = await _gl_get_entity(f'{api}/projects/{pid}', headers, timeout, verify_ssl)

...
def gitlab_get_project(auth_info: dict, project_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get a single project. Official: https://docs.gitlab.com/api/projects/#get-a-single-project"""
    try:
        ...
        records, status, msg = _gl_get_entity(
            f"{api}/projects/{pid}", headers, timeout, verify_ssl
        )

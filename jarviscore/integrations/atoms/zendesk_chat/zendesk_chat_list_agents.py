...
def zendesk_chat_list_agents(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """zendesk_chat REST: list agents. Official: https://developer.zendesk.com/api-reference/live-chat/introduction/"""
    try:
        ...
        resp = requests.get(root + "/agents", headers=headers, params={"limit": limit}, timeout=timeout, verify=verify_ssl)

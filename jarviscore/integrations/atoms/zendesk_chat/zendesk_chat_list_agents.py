...
async def zendesk_chat_list_agents(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/agents', headers=headers, params={'limit': limit})

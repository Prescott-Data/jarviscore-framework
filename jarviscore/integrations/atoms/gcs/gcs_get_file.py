...
def gcs_get_file(auth_info: dict, bucket_name: str, object_name: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get object metadata (GET .../b/{bucket}/o/{object}). OAuth Bearer token (cloud-platform or devstorage scope). JSON API root required. Official: https://cloud.google.com/storage/docs/json_api/v1"""
    try:
        if not object_name:

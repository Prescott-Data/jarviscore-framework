...
def intercom_list_conversations(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _ic_paginate(f"{api}/conversations", headers, limit, timeout, verify_ssl)

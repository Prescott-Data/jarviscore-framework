...
async def intercom_get_contact(record_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _ic_get(f'{api}/contacts/{record_id}', headers, None, timeout, verify_ssl)

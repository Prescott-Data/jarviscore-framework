...
def intercom_get_conversation(auth_info: dict, conversation_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _ic_get(f"{api}/conversations/{conversation_id}", headers, None, timeout, verify_ssl)

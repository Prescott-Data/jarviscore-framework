...
def intercom_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        body = {
            ...
            "pagination": {"per_page": min(max(int(limit or 25), 1), 150)},
        }
        resp = _ic_post(f"{api}/contacts/search", headers, body, timeout, verify_ssl)

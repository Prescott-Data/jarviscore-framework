...
async def intercom_create_contact(payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _ic_post(f'{api}/contacts', headers, payload, timeout, verify_ssl)

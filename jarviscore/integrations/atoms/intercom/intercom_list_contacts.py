...
def intercom_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _ic_paginate(f"{api}/contacts", headers, limit, timeout, verify_ssl)

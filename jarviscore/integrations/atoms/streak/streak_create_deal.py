...
def streak_create_deal(auth_info: dict, pipeline_key: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        # Streak "Create a box" is v2: POST /api/v2/pipelines/{pipelineKey}/boxes.
        resp = requests.post(root_v2 + f"/pipelines/{pipeline_key}/boxes", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)

...
async def streak_get_account(pipeline_key: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/pipelines/' + str(pipeline_key), headers=headers)
        try:

...
def streak_create_account(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        # Streak "Create a pipeline" is PUT /api/v1/pipelines with a form-urlencoded body.
        resp = requests.put(root + "/pipelines", headers=headers, data=payload, timeout=timeout, verify=verify_ssl)

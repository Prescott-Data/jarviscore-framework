...
def streak_list_deals(auth_info: dict, pipeline_key: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + f"/pipelines/{pipeline_key}/boxes", headers=headers, timeout=timeout, verify=verify_ssl)

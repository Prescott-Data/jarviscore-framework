...
def streak_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        # account=pipeline; list all pipelines for the authenticated user.
        resp = requests.get(root + "/pipelines", headers=headers, timeout=timeout, verify=verify_ssl)

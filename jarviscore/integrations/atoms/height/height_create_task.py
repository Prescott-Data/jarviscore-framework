...
def height_create_task(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _height_post(f"{api}/tasks", headers, payload, timeout, verify_ssl)

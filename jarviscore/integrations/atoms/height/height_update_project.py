...
async def height_update_project(project_id: str, payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
...
async def _height_put(url, headers, body, timeout, verify_ssl):

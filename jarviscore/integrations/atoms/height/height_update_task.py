...
def height_update_task(auth_info: dict, task_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _height_patch(f"{api}/tasks/{task_id}", headers, payload, timeout, verify_ssl)

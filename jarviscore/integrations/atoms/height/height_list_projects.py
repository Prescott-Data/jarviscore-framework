...
def height_list_projects(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _height_paginate(f"{api}/lists", headers, limit, timeout, verify_ssl)

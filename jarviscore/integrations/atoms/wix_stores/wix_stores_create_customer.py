...
def wix_stores_create_customer(auth_info: dict, email: str, site_id: str = "", first_name: str = "", last_name: str = "", phone: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/contacts/v4/contacts", headers=headers, json={"info": info}, timeout=timeout, verify=verify_ssl)

...
def wix_stores_get_product(auth_info: dict, product_id: str, site_id: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/stores/v1/products/{product_id}", headers=headers, timeout=timeout, verify=verify_ssl)

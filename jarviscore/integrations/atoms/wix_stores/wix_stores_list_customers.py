...
def wix_stores_list_customers(auth_info: dict, site_id: str = "", limit: int = 100, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/contacts/v4/contacts/query", headers=headers, json=body, timeout=timeout, verify=verify_ssl)

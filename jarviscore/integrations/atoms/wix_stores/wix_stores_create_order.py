...
def wix_stores_create_order(auth_info: dict, line_items: List[Dict[str, Any]], currency: str, site_id: str = "", buyer_email: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/ecom/v1/orders", headers=headers, json={"order": order}, timeout=timeout, verify=verify_ssl)

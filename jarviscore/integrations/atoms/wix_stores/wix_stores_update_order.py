...
def wix_stores_update_order(auth_info: dict, order_id: str, site_id: str = "", buyer_email: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.patch(f"{root}/ecom/v1/orders/{order_id}", headers=headers, json={"order": order}, timeout=timeout, verify=verify_ssl)

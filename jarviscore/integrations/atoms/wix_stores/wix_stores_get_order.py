...
async def wix_stores_get_order(order_id: str, site_id: str='', timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{root}/ecom/v1/orders/{order_id}', headers=headers)

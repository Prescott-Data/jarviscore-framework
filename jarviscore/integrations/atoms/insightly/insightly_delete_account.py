...
def insightly_delete_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _in_delete(f"{api}/Organisations/{account_id}", headers, basic, timeout, verify_ssl)

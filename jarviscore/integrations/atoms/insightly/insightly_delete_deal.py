...
ATOM_POLICY = {"effect": "destructive", "approval": "required", "idempotency_fields": ["deal_id"], "consequence": "Deletes the Insightly deal."}
INSIGHTLY_API = 'https://api.na1.insightly.com/v3.1'

async def insightly_delete_deal(deal_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _in_delete(f'{api}/Opportunities/{deal_id}', headers, basic, timeout, verify_ssl)

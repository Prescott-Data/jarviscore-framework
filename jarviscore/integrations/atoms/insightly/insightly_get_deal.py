...
def insightly_get_deal(auth_info: dict, deal_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get Insightly deal by ID. Official: https://api.na1.insightly.com/v3.1/Help"""
    try:
        if not deal_id:
        ...
        resp = _in_get(f"{api}/Opportunities/{deal_id}", headers, basic, None, timeout, verify_ssl)

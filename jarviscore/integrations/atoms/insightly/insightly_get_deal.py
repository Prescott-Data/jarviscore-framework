...
async def insightly_get_deal(deal_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _in_get(f'{api}/Opportunities/{deal_id}', headers, basic, None, timeout, verify_ssl)

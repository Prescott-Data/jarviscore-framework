...
def insightly_create_contact(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _in_post(f"{api}/Contacts", headers, basic, payload, timeout, verify_ssl)

...
def insightly_update_contact(auth_info: dict, contact_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _in_put(f"{api}/Contacts", headers, basic, body, timeout, verify_ssl)

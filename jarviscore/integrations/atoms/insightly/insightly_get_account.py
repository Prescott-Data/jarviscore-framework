...
async def insightly_get_account(account_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _in_get(f'{api}/Organisations/{account_id}', headers, basic, None, timeout, verify_ssl)

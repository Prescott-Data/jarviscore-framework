...
def insightly_get_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get Insightly account by ID. Official: https://api.na1.insightly.com/v3.1/Help"""
    try:
        if not account_id:
        ...
        resp = _in_get(f"{api}/Organisations/{account_id}", headers, basic, None, timeout, verify_ssl)

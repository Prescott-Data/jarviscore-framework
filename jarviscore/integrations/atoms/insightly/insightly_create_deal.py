...
def insightly_create_deal(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create Insightly deal. Official: https://api.na1.insightly.com/v3.1/Help"""
    try:
        if not payload:
        ...
        resp = _in_post(f"{api}/Opportunities", headers, basic, payload, timeout, verify_ssl)

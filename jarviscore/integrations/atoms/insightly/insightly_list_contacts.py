...
def insightly_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _in_paginate(f"{api}/Contacts", headers, basic, limit, timeout, verify_ssl)

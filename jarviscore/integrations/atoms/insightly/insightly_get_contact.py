...
def insightly_get_contact(auth_info: dict, contact_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get Insightly contact by ID. Official: https://api.na1.insightly.com/v3.1/Help"""
    try:
        if not contact_id:
        ...
        resp = _in_get(f"{api}/Contacts/{contact_id}", headers, basic, None, timeout, verify_ssl)

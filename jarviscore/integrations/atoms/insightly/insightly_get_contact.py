...
async def insightly_get_contact(contact_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _in_get(f'{api}/Contacts/{contact_id}', headers, basic, None, timeout, verify_ssl)

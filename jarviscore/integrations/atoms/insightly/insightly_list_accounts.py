...
def insightly_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List Insightly accounts (API resource Organisations). Official: https://api.na1.insightly.com/v3.1/Help"""
    try:
        ...
        records, status, message = _in_paginate(f"{api}/Organisations", headers, basic, limit, timeout, verify_ssl)

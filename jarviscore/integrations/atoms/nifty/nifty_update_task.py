...
# https://developers.niftypm.com/operation/operation-taskapicontroller_edittask
...
def nifty_update_task(auth_info: dict, task_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(f"{root}/tasks/{task_id}", headers=headers, json=body, timeout=timeout, verify=verify_ssl)
        try:

...
# https://developers.niftypm.com/operation/operation-projectapicontroller_updateproject
...
def nifty_update_project(auth_info: dict, project_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(f"{root}/projects/{project_id}", headers=headers, data=form, timeout=timeout, verify=verify_ssl)
        try:

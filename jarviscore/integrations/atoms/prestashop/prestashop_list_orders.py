...
def prestashop_list_orders(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List orders via PrestaShop webservice. Official: https://devdocs.prestashop-project.org/9/webservice/getting-started/"""
    try:
        records, status, msg = _ps_list("orders", base_url, auth_info, limit, timeout, verify_ssl)

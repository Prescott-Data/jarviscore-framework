...
def shortcut_create_task(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Shortcut API v3: create task. Official: https://developer.shortcut.com/api/rest/v3#Stories/createStory"""
    try:
        ...
        resp = requests.post(root + "/stories", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)

...
def shortcut_create_project(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Shortcut API v3: create project. Official: https://developer.shortcut.com/api/rest/v3#Projects/createProject"""
    try:
        ...
        resp = requests.post(root + "/projects", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)
        ...
        return _sc_provision(data if isinstance(data, dict) else {}, resp.status_code, "ok")

...
async def tiktok_ads_get_campaign(campaign_id: str, advertiser_id: str='', timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        if not campaign_id:
            return _tt_dataset([], 400, 'campaign_id is required')
        ...
        resp = await nexus_call('GET', root + '/campaign/get/', headers=headers, params={'advertiser_id': aid, 'filtering': '{"campaign_ids": ["' + str(campaign_id) + '"]}'})

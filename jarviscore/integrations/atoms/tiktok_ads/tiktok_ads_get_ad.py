...
async def tiktok_ads_get_ad(ad_id: str, advertiser_id: str='', timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        if not ad_id:
            return _tt_dataset([], 400, 'ad_id is required')
        ...
        resp = await nexus_call('GET', root + '/ad/get/', headers=headers, params={'advertiser_id': aid, 'filtering': '{"ad_ids": ["' + str(ad_id) + '"]}'})

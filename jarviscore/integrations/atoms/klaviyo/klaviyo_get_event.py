...
async def klaviyo_get_event(event_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _kv_get(f'{api}/api/events/{event_id}/', headers, None, timeout, verify_ssl)

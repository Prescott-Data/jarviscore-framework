...
async def klaviyo_delete_profile(profile_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        body = {'data': {'type': 'data-privacy-deletion-job', 'attributes': {'profile': {'data': {'type': 'profile', 'id': profile_id}}}}}
        resp = await _kv_post(f'{api}/api/data-privacy-deletion-jobs/', headers, body, timeout, verify_ssl)

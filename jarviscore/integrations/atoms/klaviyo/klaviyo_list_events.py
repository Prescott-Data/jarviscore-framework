...
def klaviyo_list_events(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _kv_paginate(f"{api}/api/events/", headers, limit, timeout, verify_ssl)

...
async def klaviyo_get_report(report_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _kv_get(f'{api}/api/metrics/{report_id}/', headers, None, timeout, verify_ssl)

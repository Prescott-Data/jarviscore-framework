...
def workfront_list_tasks(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + "/task/search", headers=headers, params={"$$LIMIT": limit}, timeout=timeout, verify=verify_ssl)

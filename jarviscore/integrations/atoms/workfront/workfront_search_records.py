...
def workfront_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """workfront REST: search records. Official: https://developer.adobe.com/workfront/api-explorer/"""
    try:
        ...
        resp = requests.get(root + "/proj/search", headers=headers, params={"name": query}, timeout=timeout, verify=verify_ssl)

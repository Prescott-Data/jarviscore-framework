...
async def workfront_list_projects(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/proj/search', headers=headers, params={'$$LIMIT': limit})

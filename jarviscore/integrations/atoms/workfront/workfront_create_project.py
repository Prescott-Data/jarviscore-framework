...
def workfront_create_project(auth_info: dict, name: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(root + "/proj", headers=headers, json={'name': name}, timeout=timeout, verify=verify_ssl)

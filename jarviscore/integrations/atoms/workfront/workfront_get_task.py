...
def workfront_get_task(auth_info: dict, task_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + "/task/" + str(task_id), headers=headers, timeout=timeout, verify=verify_ssl)

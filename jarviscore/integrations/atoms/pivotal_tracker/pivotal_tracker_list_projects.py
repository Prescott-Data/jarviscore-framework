...
def pivotal_tracker_list_projects(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        if not isinstance(extra, dict):
            extra = {}
        records, status, msg = _pt_paginate("/projects", base_url, auth_info, limit, timeout, verify_ssl, extra_params=extra)

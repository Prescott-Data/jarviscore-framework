...
def pivotal_tracker_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, body, status, msg = _pt_request(
            "get",
            root + "/projects/" + str(project_id).strip() + "/search",
            auth_info,
            params=params,
            timeout=timeout,

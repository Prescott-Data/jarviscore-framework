...
async def zoho_crm_search_records(query: str, limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/' + module + '/search', headers=headers, params={'word': str(query), 'per_page': _cap(limit)})

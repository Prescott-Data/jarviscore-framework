...
def zoho_crm_create_lead(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(root + "/Leads", headers=headers, json={"data": [payload]}, timeout=timeout, verify=verify_ssl)

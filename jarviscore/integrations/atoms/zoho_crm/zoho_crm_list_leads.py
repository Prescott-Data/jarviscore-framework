...
def zoho_crm_list_leads(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """zoho_crm REST: list leads. Official: https://www.zoho.com/crm/developer/docs/api/v2/"""
    try:
        ...
        resp = requests.get(root + "/Leads", headers=headers, params={"per_page": _cap(limit)}, timeout=timeout, verify=verify_ssl)

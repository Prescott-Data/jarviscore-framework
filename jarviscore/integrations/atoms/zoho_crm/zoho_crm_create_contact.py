...
def zoho_crm_create_contact(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """zoho_crm REST: create contact. Official: https://www.zoho.com/crm/developer/docs/api/v2/"""
    try:
        ...
        resp = requests.post(root + "/Contacts", headers=headers, json={"data": [payload]}, timeout=timeout, verify=verify_ssl)

...
def zoho_crm_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + "/Contacts", headers=headers, params={"per_page": _cap(limit)}, timeout=timeout, verify=verify_ssl)

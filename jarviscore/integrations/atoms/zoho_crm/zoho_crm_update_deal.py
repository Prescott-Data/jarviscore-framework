...
async def zoho_crm_update_deal(deal_id: str, payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('PUT', root + '/Deals/' + str(deal_id), headers=headers, json={'data': [payload]})

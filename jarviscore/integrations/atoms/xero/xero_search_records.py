...
def xero_search_records(auth_info: dict, query: str, tenant_id: str = "", limit: int = 100, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _x_paginate(root, "Contacts", "Contacts", headers, limit, {"searchTerm": query}, timeout, verify_ssl)

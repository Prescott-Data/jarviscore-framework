...
def xero_get_invoice(auth_info: dict, invoice_id: str, tenant_id: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/Invoices/{invoice_id}", headers=headers, timeout=timeout, verify=verify_ssl)

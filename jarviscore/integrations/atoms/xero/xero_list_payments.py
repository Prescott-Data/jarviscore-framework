...
def xero_list_payments(auth_info: dict, tenant_id: str = "", limit: int = 100, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _x_paginate(root, "Payments", "Payments", headers, limit, None, timeout, verify_ssl)

...
async def xero_list_invoices(tenant_id: str='', limit: int=100, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        records, status, msg = await _x_paginate(root, 'Invoices', 'Invoices', headers, limit, None, timeout, verify_ssl)

...
def xero_list_invoices(auth_info: dict, tenant_id: str = "", limit: int = 100, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """xero REST: list invoices. Official: https://developer.xero.com/documentation/api/accounting/overview"""
    try:
        ...
        records, status, msg = _x_paginate(root, "Invoices", "Invoices", headers, limit, None, timeout, verify_ssl)

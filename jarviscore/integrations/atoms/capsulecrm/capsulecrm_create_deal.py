...
def capsulecrm_create_deal(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _capsule_post_json(f"{api}/opportunities", headers, body, timeout, verify_ssl)

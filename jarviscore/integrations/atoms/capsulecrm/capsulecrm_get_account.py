...
def capsulecrm_get_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _capsule_get(f"{api}/parties/{account_id}", headers, None, timeout, verify_ssl)

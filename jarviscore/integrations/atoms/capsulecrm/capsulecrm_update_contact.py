...
def capsulecrm_update_contact(auth_info: dict, contact_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _capsule_put_json(f"{api}/parties/{contact_id}", headers, body, timeout, verify_ssl)

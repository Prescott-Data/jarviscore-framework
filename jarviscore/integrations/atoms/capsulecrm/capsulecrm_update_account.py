...
def capsulecrm_update_account(auth_info: dict, account_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Update Account via Capsule CRM API. Official: https://developer.capsulecrm.com/v2/operations/Party"""
    try:
        ...
        resp = _capsule_put_json(f"{api}/parties/{account_id}", headers, body, timeout, verify_ssl)

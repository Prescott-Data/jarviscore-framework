...
async def capsulecrm_update_account(account_id: str, payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _capsule_put_json(f'{api}/parties/{account_id}', headers, body, timeout, verify_ssl)

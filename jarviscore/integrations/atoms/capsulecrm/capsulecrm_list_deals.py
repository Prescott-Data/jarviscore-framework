...
async def capsulecrm_list_deals(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, message) = await _capsule_paginate(f'{api}/opportunities', headers, limit, timeout, verify_ssl)

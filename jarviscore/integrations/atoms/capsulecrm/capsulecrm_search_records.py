...
def capsulecrm_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _capsule_search(f"{api}/parties/search", headers, query, limit, timeout, verify_ssl)

...
async def capsulecrm_get_contact(contact_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _capsule_get(f'{api}/parties/{contact_id}', headers, None, timeout, verify_ssl)

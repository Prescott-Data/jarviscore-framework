...
def capsulecrm_get_contact(auth_info: dict, contact_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get Contact via Capsule CRM API. Official: https://developer.capsulecrm.com/v2/operations/Party"""
    try:
        if not contact_id:
        ...
        resp = _capsule_get(f"{api}/parties/{contact_id}", headers, None, timeout, verify_ssl)

...
def capsulecrm_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _capsule_paginate(
            f"{api}/parties", headers, limit, timeout, verify_ssl, party_type="organisation"
        )

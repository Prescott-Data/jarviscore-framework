...
async def nimble_get_account(account_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, msg) = await _nb_get_one(f'{root}/contact/{account_id}', headers, timeout, verify_ssl)

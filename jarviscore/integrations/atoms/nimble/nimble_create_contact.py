...
# Create contact — POST /api/v1/contact (JSON). Official: https://www.nimble.com/developers/docs/


def nimble_create_contact(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

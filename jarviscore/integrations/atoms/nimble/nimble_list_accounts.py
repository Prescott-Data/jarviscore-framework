...
# List company accounts — GET /api/v1/contacts?record_type=company (companies are contact records). Official: https://www.nimble.com/developers/docs/


def nimble_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

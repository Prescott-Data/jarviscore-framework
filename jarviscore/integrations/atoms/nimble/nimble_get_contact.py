...
# Get contact — GET /api/v1/contact/{contact_id}. Official: https://www.nimble.com/developers/docs/


def nimble_get_contact(auth_info: dict, contact_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _nb_get_one(f"{root}/contact/{contact_id}", headers, timeout, verify_ssl)

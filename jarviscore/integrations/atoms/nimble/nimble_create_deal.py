...
# Create deal — POST /api/v2/deals. Official: https://www.nimble.com/developers/docs/


def nimble_create_deal(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/deals", headers=headers, json=body, timeout=timeout, verify=verify_ssl)

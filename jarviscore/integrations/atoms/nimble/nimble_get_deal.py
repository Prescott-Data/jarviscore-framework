...
# Get deal — GET /api/v2/deals/{deal_id}. Official: https://www.nimble.com/developers/docs/


def nimble_get_deal(auth_info: dict, deal_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get deal by id. Official: https://www.nimble.com/developers/docs/"""
    try:
        if not deal_id:
        ...
        records, status, msg = _nb_get_one(f"{root}/deals/{deal_id}", headers, timeout, verify_ssl)

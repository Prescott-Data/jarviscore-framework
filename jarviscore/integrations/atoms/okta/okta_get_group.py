...
# Get group — GET /api/v1/groups/{groupId}. Official: https://developer.okta.com/docs/reference/api/groups/


def okta_get_group(auth_info: dict, domain: str, group_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/groups/{group_id}", headers=headers, timeout=timeout, verify=verify_ssl)

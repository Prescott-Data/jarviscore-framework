...
# Create group — POST /api/v1/groups. Official: https://developer.okta.com/docs/api/openapi/okta-management/management/tags/group/other/addgroup


def okta_create_group(auth_info: dict, domain: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/groups", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)

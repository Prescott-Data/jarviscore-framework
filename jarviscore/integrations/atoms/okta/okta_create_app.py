...
# Create application — POST /api/v1/apps. Official: https://developer.okta.com/docs/reference/api/apps/


def okta_create_app(auth_info: dict, domain: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/apps", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)

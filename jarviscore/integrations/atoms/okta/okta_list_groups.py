...
async def okta_list_groups(domain: str, limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        records, status, msg = await _ok_paginate(f'{root}/groups', headers, params, limit, timeout, verify_ssl)

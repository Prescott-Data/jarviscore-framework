...
# List groups — GET /api/v1/groups. Official: https://developer.okta.com/docs/api/openapi/okta-management/management/tags/group/other/listgroups


def okta_list_groups(auth_info: dict, domain: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List groups with Link pagination. Official: https://developer.okta.com/docs/reference/api/overview/"""
    try:
        ...
        records, status, msg = _ok_paginate(f"{root}/groups", headers, params, limit, timeout, verify_ssl)

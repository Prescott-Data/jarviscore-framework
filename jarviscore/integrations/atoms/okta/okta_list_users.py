...
# List users — GET /api/v1/users. Official: https://developer.okta.com/docs/api/openapi/okta-management/management/tags/user/other/listusers


def okta_list_users(auth_info: dict, domain: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _ok_paginate(f"{root}/users", headers, params, limit, timeout, verify_ssl)

...
def teamcity_list_builds(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/builds", headers=headers, params={"locator": f"count:{limit}"}, timeout=timeout, verify=verify_ssl)

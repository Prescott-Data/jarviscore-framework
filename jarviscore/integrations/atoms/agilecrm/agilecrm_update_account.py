...
def agilecrm_update_account(auth_info: dict, account_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Update company via PUT /contacts/edit-properties. Official: https://github.com/agilecrm/rest-api#22-updating-a-company"""
    try:
        if not account_id:
            return _ac_provision([], 400, "account_id is required")
        ...
        return _ac_provision(records, status, "ok", _ac_provision_ids(data, account_id))
    except Exception as e:
        return _ac_provision([], 500, str(e))


# PUT /contacts/edit-properties — https://github.com/agilecrm/rest-api#22-updating-a-company

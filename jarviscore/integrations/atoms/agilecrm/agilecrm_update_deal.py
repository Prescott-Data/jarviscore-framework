...
def agilecrm_update_deal(auth_info: dict, deal_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Update deal via PUT /opportunity/partial-update. Official: https://github.com/agilecrm/rest-api#34-update-deal-partial-update"""
    try:
        if not deal_id:
            return _ac_provision([], 400, "deal_id is required")
        ...
        body["id"] = str(deal_id)
        resp = requests.put(
            f"{api_root}/opportunity/partial-update",
        ...
        return _ac_provision(records, status, "ok", _ac_provision_ids(data, deal_id))
    except Exception as e:
        return _ac_provision([], 500, str(e))


# PUT /opportunity/partial-update — https://github.com/agilecrm/rest-api#34-update-deal-partial-update

...
def agilecrm_get_account(auth_info: dict, account_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get company via GET /contacts/{id}. Official: https://github.com/agilecrm/rest-api#24-get-company-by-id"""
    try:
        if not account_id:
            return _ac_dataset([], 400, "account_id is required")
        ...
        resp = requests.get(
            f"{api_root}/contacts/{account_id}",
...
# GET /contacts/{id} — https://github.com/agilecrm/rest-api#24-get-company-by-id

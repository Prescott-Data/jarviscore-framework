...
def agilecrm_get_contact(auth_info: dict, contact_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get contact via GET /contacts/{id}. Official: https://github.com/agilecrm/rest-api#12-get-contact-by-id"""
    try:
        if not contact_id:
            return _ac_dataset([], 400, "contact_id is required")
...
# GET /contacts/{id} — https://github.com/agilecrm/rest-api#12-get-contact-by-id

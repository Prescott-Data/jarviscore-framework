...
def agilecrm_list_deals(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List deals via GET /opportunity. Official: https://github.com/agilecrm/rest-api#31-listing-deals"""
    try:
...
# GET /opportunity — https://github.com/agilecrm/rest-api#31-listing-deals

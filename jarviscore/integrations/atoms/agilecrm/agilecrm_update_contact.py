...
def agilecrm_update_contact(auth_info: dict, contact_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Update contact via PUT /contacts/edit-properties. Official: https://github.com/agilecrm/rest-api#14-update-properties-of-a-contact-by-id-partial-update"""
    try:
        if not contact_id:
            return _ac_provision([], 400, "contact_id is required")
        ...
        body["id"] = contact_id
        resp = requests.put(
            f"{api_root}/contacts/edit-properties",
        ...
        return _ac_provision(records, status, "ok", _ac_provision_ids(data, contact_id))
    except Exception as e:
        return _ac_provision([], 500, str(e))


# PUT /contacts/edit-properties — https://github.com/agilecrm/rest-api#14-update-properties-of-a-contact-by-id-partial-update
...
def _ac_provision_ids(data, fallback_id=None):

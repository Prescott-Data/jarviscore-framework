...
def agilecrm_create_account(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create company via POST /contacts (type=COMPANY). Official: https://github.com/agilecrm/rest-api#21-creating-a-company"""
    try:
...
# POST /contacts (type=COMPANY) — https://github.com/agilecrm/rest-api#21-creating-a-company

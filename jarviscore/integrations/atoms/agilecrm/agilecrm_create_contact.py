...
def agilecrm_create_contact(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create contact via POST /contacts. Official: https://github.com/agilecrm/rest-api#13-creating-a-contact"""
    try:
...
# POST /contacts — https://github.com/agilecrm/rest-api#13-creating-a-contact

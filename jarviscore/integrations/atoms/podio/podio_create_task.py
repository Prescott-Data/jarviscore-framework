...
def podio_create_task(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create task. Official: https://developers.podio.com/doc/tasks/create-task-22419"""
    try:
        ...
        resp, body, status, msg = _po_request("post", root + "/task/", auth_info, json_body=payload, timeout=timeout, verify_ssl=verify_ssl)
        if status >= 400:

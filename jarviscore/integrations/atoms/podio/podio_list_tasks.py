...
def podio_list_tasks(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        params = _po_scope_params(auth_info)
        ...
        records, status, msg = _po_paginate_get("/task/", base_url, auth_info, limit, timeout, verify_ssl, base_params=params)

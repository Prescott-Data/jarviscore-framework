...
async def _jsc_call(base, action, user_id, api_key, extra=None, body=None, timeout=30, verify_ssl=True):
    ...
    return await nexus_call('GET', f'{base}/', params=params)
...
def _jsc_product_xml(payload):
    ...
    field_map = {'seller_sku': 'SellerSku', 'SellerSku': 'SellerSku', 'name': 'Name', 'Name': 'Name', 'primary_category': 'PrimaryCategory', 'PrimaryCategory': 'PrimaryCategory', 'description': 'Description', 'Description': 'Description', 'brand': 'Brand', 'Brand': 'Brand', 'price': 'Price', 'Price': 'Price', 'quantity': 'Quantity', 'Quantity': 'Quantity', 'parent_sku': 'ParentSku', 'ParentSku': 'ParentSku'}

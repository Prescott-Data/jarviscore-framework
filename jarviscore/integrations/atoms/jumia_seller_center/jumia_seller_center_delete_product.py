...
async def jumia_seller_center_delete_product(product_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _jsc_call(base, 'ProductRemove', user_id, api_key, body=body, timeout=timeout, verify_ssl=verify_ssl)
        data = _jsc_json(resp)

...
async def jumia_seller_center_list_orders(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _jsc_call(base, 'GetOrders', user_id, api_key, extra, timeout=timeout, verify_ssl=verify_ssl)
        data = _jsc_json(resp)

...
# Jumia Seller Center API — http://sellerapi.sellercenter.jumia.com/v2.7.11/sales-order-endpoints/getorder/
JUMIA_SC_API = "http://sellerapi.sellercenter.jumia.com"
SC_VERSION = "1.0"


def jumia_seller_center_get_order(auth_info: dict, order_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _jsc_call(base, "GetOrder", user_id, api_key, extra, timeout=timeout, verify_ssl=verify_ssl)
        data = _jsc_json(resp)

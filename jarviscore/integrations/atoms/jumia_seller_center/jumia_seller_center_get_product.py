...
async def jumia_seller_center_get_product(product_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    """Get product by SellerSku via GetProducts. Official: http://sellerapi.sellercenter.jumia.com/v2.7.11/product-endpoints/getproducts/"""
    try:
        if not product_id:

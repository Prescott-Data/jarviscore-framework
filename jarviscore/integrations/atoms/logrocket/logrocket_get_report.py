...
def logrocket_get_report(auth_info: dict, org_id: str, app_id: str, report_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{app_base}/highlights", headers=headers, params={"id": report_id}, timeout=timeout, verify=verify_ssl)

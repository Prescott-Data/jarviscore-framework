...
def logrocket_search_records(auth_info: dict, org_id: str, app_id: str, query: str = "", limit: int = 25, cursor: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{app_base}/data-export/", headers=headers, params=params, timeout=timeout, verify=verify_ssl)

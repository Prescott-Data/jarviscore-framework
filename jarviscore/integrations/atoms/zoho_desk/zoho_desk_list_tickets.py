...
# Zoho Desk API v1 — Official: https://desk.zoho.com/DeskAPIDocument#list-tickets
...
def zoho_desk_list_tickets(auth_info: dict, org_id: str = "", limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """zoho_desk API: list tickets. Official: https://desk.zoho.com/DeskAPIDocument"""
    try:
        ...
        records, status, msg = _zd_paginate(f"{root}/tickets", headers, limit, timeout, verify_ssl)

...
async def zoho_desk_list_tickets(org_id: str='', limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, msg) = await _zd_paginate(f'{root}/tickets', headers, limit, timeout, verify_ssl)

...
# Zoho Desk API v1 — Official: https://desk.zoho.com/DeskAPIDocument#get-contact
...
def zoho_desk_get_contact(auth_info: dict, contact_id: str, org_id: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

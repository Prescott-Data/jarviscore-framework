...
# Zoho Desk API v1 — Official: https://desk.zoho.com/DeskAPIDocument#list-departments
...
def zoho_desk_list_departments(auth_info: dict, org_id: str = "", limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _zd_paginate(f"{root}/departments", headers, limit, timeout, verify_ssl)

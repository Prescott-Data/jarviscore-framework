...
async def zoho_desk_create_department(name: str, description: str='', org_id: str='', timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('POST', f'{root}/departments', headers=headers, json=body)

...
# Zoho Desk API v1 — Official: https://desk.zoho.com/DeskAPIDocument#get-ticket
...
def zoho_desk_get_ticket(auth_info: dict, ticket_id: str, org_id: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """zoho_desk API: get ticket. Official: https://desk.zoho.com/DeskAPIDocument"""
    try:
        if not ticket_id:
        ...
        resp = requests.get(f"{root}/tickets/{ticket_id}", headers=headers, timeout=timeout, verify=verify_ssl)

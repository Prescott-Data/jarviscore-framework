...
async def zoho_desk_update_ticket(ticket_id: str, subject: str='', status: str='', priority: str='', org_id: str='', timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('PATCH', f'{root}/tickets/{ticket_id}', headers=headers, json=body)

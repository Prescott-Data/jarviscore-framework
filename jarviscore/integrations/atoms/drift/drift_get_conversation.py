...
# Drift get conversation — https://devdocs.drift.com/docs/retrieve-a-conversation
DRIFT_CONV_HOST = "https://driftapi.com"


def drift_get_conversation(auth_info: dict, conversation_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _drift_get(f"{root}/conversations/{conversation_id}", headers, None, timeout, verify_ssl)

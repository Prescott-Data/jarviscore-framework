...
async def shopify_get_product(product_id: str, shop: str='', timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/products/{product_id}.json'.format(**locals()), headers=headers)
        try:

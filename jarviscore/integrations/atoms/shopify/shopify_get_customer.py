...
def shopify_get_customer(auth_info: dict, customer_id: str, shop: str = "", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + "/customers/{customer_id}.json".format(**locals()), headers=headers, timeout=timeout, verify=verify_ssl)
        try:

...
async def shopify_list_orders(shop: str='', limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, msg) = await _sh_paginate(root, '/orders.json', 'orders', limit, timeout, verify_ssl)

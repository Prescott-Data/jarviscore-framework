...
def shopify_list_customers(auth_info: dict, shop: str = "", limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _sh_paginate(root, "/customers.json", auth_info, "customers", limit, timeout, verify_ssl)

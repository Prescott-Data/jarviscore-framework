...
async def mattermost_list_messages(channel_id: str, limit: int=25, page: int=0, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{root}/channels/{cid}/posts', headers=headers, params=params)
        try:
...
def _mm_channel_id(channel_id):
    val = channel_id or None or None

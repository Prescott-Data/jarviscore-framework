...
def google_people_search_contacts(auth_info: dict, query: str, read_mask: str = "names,emailAddresses,phoneNumbers", max_results: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _people_page(
            url, headers, {"query": query, "readMask": read_mask}, "results", max_results, timeout, verify_ssl
        )

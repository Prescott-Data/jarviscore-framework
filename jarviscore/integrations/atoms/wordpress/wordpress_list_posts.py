...
def wordpress_list_posts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """wordpress REST: list posts. Official: https://developer.wordpress.org/rest-api/"""
    try:
        ...
        resp = requests.get(root + "/posts", headers=hdrs, auth=auth, params={'per_page': limit}, timeout=timeout, verify=verify_ssl)

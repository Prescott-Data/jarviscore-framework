...
def wordpress_create_post(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(root + '/posts', headers=hdrs, auth=auth, json=payload, timeout=timeout, verify=verify_ssl)

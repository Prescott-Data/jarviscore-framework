...
async def wordpress_search_records(query: str, limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/posts', headers=hdrs, params={'search': query, 'per_page': limit})

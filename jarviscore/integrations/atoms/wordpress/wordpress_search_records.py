...
def wordpress_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """wordpress REST: search. Official: https://developer.wordpress.org/rest-api/"""
    try:
        ...
        resp = requests.get(root + "/posts", headers=hdrs, auth=auth, params={"search": query, "per_page": limit}, timeout=timeout, verify=verify_ssl)

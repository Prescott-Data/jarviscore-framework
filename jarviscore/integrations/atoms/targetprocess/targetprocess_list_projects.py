...
def targetprocess_list_projects(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _tp_paginate(f"{root}/Projects", auth_info, {}, limit, timeout, verify_ssl)

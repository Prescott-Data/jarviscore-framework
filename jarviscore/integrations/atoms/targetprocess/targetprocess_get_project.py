...
async def targetprocess_get_project(project_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', f'{root}/Projects/{project_id}', headers=headers, params={'format': 'json'})

...
# POST /v1/spaces.json — https://api-docs.assembla.cc/content/ref/spaces_create.html
_ASSEMBLA_V1_SUFFIX = "/v1"


def assembla_create_project(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

...
async def assembla_update_project(project_id: str, payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('PUT', url, headers=headers, json=_assembla_wrap_namespace('space', payload))

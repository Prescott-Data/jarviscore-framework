...
def assembla_list_projects(auth_info: dict, limit: int = 25, with_tools: Optional[str] = None, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(url, headers=headers, params=params or None, timeout=timeout, verify=verify_ssl)

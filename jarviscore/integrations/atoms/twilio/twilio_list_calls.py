...
def twilio_list_calls(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/Calls.json", auth=(sid, token), params={"PageSize": limit}, timeout=timeout, verify=verify_ssl)

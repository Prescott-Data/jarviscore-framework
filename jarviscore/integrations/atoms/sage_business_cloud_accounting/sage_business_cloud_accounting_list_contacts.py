...
def sage_business_cloud_accounting_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List contacts. Official: https://developer.sage.com/accounting/reference/"""
    try:
        records, status, msg = _sage_list_collection("/contacts", base_url, auth_info, limit, timeout, verify_ssl)

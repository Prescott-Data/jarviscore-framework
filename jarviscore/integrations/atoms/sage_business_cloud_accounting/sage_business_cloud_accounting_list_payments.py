...
def sage_business_cloud_accounting_list_payments(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List contact payments. Official: https://developer.sage.com/accounting/reference/"""
    try:
        records, status, msg = _sage_list_collection("/contact_payments", base_url, auth_info, limit, timeout, verify_ssl)

...
async def sage_business_cloud_accounting_update_invoice(invoice_id: str, payload: Dict[str, Any], timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:

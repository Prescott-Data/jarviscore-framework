...
async def pipedrive_get_deal(deal_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    """Get deal by ID. Official: https://developers.pipedrive.com/docs/api/v1/Deals"""
    try:
        records, status, msg = await _pi_get('/deals', base_url, deal_id, timeout, verify_ssl)

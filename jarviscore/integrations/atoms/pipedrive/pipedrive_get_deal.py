...
def pipedrive_get_deal(auth_info: dict, deal_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get deal by ID. Official: https://developers.pipedrive.com/docs/api/v1/Deals"""
    try:
        records, status, msg = _pi_get("/deals", base_url, auth_info, deal_id, timeout, verify_ssl)

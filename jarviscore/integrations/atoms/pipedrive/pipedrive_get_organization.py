...
def pipedrive_get_organization(auth_info: dict, organization_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get organization by ID. Official: https://developers.pipedrive.com/docs/api/v1/Organizations"""
    try:
        records, status, msg = _pi_get("/organizations", base_url, auth_info, organization_id, timeout, verify_ssl)

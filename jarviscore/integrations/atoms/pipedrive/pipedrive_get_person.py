...
def pipedrive_get_person(auth_info: dict, person_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Get person by ID. Official: https://developers.pipedrive.com/docs/api/v1/Persons"""
    try:
        records, status, msg = _pi_get("/persons", base_url, auth_info, person_id, timeout, verify_ssl)

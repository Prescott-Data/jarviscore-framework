...
def pipedrive_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        while len(records) < cap:
            ...
            item_types = auth_info.get("item_types")
            if item_types:
            ...
            resp, body, status, msg = _pi_request("get", root + "/itemSearch", auth_info, params=params, timeout=timeout, verify_ssl=verify_ssl)
            if status >= 400:

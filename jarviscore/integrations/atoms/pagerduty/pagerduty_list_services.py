...
def pagerduty_list_services(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _pd_paginate(root + "/services", auth_info, {}, limit, timeout, verify_ssl, "services")

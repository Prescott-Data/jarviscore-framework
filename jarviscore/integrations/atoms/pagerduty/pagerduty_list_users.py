...
async def pagerduty_list_users(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, msg) = await _pd_paginate(root + '/users', {}, limit, timeout, verify_ssl, 'users')

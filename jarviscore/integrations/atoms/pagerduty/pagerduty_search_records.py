...
def pagerduty_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        for key, param in (
            ...
            if isinstance(val, list):
                ...
                params[param] = val
        records, status, msg = _pd_paginate(root + "/incidents", auth_info, params, limit, timeout, verify_ssl, "incidents")

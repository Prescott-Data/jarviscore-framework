...
def jenkins_list_projects(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records = _jk_jobs(resp.json() if resp.text else {})[:limit]

...
def jenkins_delete_pipeline(auth_info: dict, job_name: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _jk_post(f"{base}{path}/doDelete", basic, headers, None, timeout, verify_ssl)

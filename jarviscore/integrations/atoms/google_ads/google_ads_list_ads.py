...
def google_ads_list_ads(auth_info: dict, customer_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        query = (
            ...
            f"FROM ad_group_ad ORDER BY ad_group_ad.ad.id LIMIT {cap}"
        )

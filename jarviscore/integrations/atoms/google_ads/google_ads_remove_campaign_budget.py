...
ATOM_POLICY = {"effect": "destructive", "approval": "required", "idempotency_fields": ["customer_id", "budget_id"], "consequence": "Removes the Google Ads campaign budget."}
_GADS_API_ROOT = 'https://googleads.googleapis.com/v24'

async def google_ads_remove_campaign_budget(customer_id: str, budget_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    """Remove a campaign budget in google ads. Official: https://developers.google.com/google-ads/api/rest/reference/rest/v24/customers.campaignBudgets/mutate"""
    try:

...
def google_ads_get_campaign_budget(auth_info: dict, customer_id: str, budget_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        query = (
            ...
            "campaign_budget.delivery_method, campaign_budget.status, campaign_budget.type, "

...
def google_ads_get_keyword(auth_info: dict, customer_id: str, criterion_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        query = (
            ...
            "ad_group_criterion.negative, ad_group_criterion.ad_group, "
            "ad_group_criterion.resource_name "
            f"FROM ad_group_criterion WHERE ad_group_criterion.criterion_id = {criterion_id}"
        )

...
def google_ads_list_keywords(auth_info: dict, customer_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        query = (
            ...
            f"ORDER BY ad_group_criterion.criterion_id LIMIT {cap}"
        )

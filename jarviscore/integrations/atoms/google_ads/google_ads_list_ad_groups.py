...
def google_ads_list_ad_groups(auth_info: dict, customer_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        query = (
            ...
            "ad_group.campaign, ad_group.resource_name "
            f"FROM ad_group ORDER BY ad_group.id LIMIT {cap}"
        )

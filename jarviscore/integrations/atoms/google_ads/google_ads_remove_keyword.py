...
def google_ads_remove_keyword(auth_info: dict, customer_id: str, criterion_id: str, resource_name: Optional[str] = None, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

...
def google_ads_update_ad_group(auth_info: dict, customer_id: str, ad_group_id: str, payload: Dict[str, Any], update_mask: Optional[str] = None, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

...
def google_ads_create_ad_group(auth_info: dict, customer_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create a ad group in google ads. Official: https://developers.google.com/google-ads/api/rest/reference/rest/v24/customers.adGroups/mutate"""
    try:
        ...
        data, status, msg = _gads_mutate(api, cid, "adGroups", headers, body, timeout, verify_ssl)

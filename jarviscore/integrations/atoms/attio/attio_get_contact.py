...
async def attio_get_contact(contact_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    """Get person record (GET /v2/objects/people/records/{record_id}). Official: https://docs.attio.com/rest-api/endpoint-reference/records/get-a-record"""
    try:
        if not base_url:
        ...
        resp = await nexus_call('GET', f'{api_root}/objects/people/records/{contact_id}', headers=headers)

...
# POST /v2/objects/companies/records — https://docs.attio.com/rest-api/endpoint-reference/records/create-a-record
...
def attio_create_account(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create company record (POST /v2/objects/companies/records). Official: https://docs.attio.com/rest-api/endpoint-reference/records/create-a-record"""
    try:
        if not base_url:
        ...
        resp = requests.post(
            f"{api_root}/objects/companies/records",
            headers=headers,

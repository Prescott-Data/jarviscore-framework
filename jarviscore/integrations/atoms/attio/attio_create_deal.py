...
# POST /v2/objects/deals/records — https://docs.attio.com/rest-api/endpoint-reference/records/create-a-record
...
def attio_create_deal(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(
            f"{api_root}/objects/deals/records",
            headers=headers,

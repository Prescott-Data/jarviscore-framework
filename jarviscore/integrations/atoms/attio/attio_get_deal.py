...
async def attio_get_deal(deal_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    """Get deal record (GET /v2/objects/deals/records/{record_id}). Official: https://docs.attio.com/rest-api/endpoint-reference/records/get-a-record"""
    try:
        if not base_url:
        ...
        resp = await nexus_call('GET', f'{api_root}/objects/deals/records/{deal_id}', headers=headers)

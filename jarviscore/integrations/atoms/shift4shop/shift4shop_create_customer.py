...
def shift4shop_create_customer(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Shift4Shop REST: create customer. Official: https://developers.3dcart.com/rest-api/customers"""
    try:
        ...
        resp = requests.post(root + "/Customers", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)
        ...
        return _s4_provision(data if isinstance(data, dict) else {}, resp.status_code, "ok")

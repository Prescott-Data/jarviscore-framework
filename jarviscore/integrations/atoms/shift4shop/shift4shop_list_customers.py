...
def shift4shop_list_customers(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Shift4Shop REST: list customer. Official: https://developers.3dcart.com/rest-api/customers"""
    try:
        ...
        resp = requests.get(root + "/Customers", headers=headers, params={"limit": _s4_cap(limit)}, timeout=timeout, verify=verify_ssl)

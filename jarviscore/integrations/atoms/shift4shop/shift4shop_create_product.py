...
def shift4shop_create_product(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Shift4Shop REST: create product. Official: https://developers.3dcart.com/rest-api/products"""
    try:
        ...
        resp = requests.post(root + "/Products", headers=headers, json=payload, timeout=timeout, verify=verify_ssl)

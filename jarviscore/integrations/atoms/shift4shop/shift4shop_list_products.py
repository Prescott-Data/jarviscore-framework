...
def shift4shop_list_products(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(root + "/Products", headers=headers, params={"limit": _s4_cap(limit)}, timeout=timeout, verify=verify_ssl)

def netsuite_update_record(auth_info: dict, account_id: str, record_type: str, record_id: str, fields: dict) -> dict:
    import requests
    ...
    def _delete(p, headers=None):
        ...
        _r.raise_for_status()
        return _r.json() if _r.content else {}
    return _patch(f"/{record_type}/{record_id}", data=fields)

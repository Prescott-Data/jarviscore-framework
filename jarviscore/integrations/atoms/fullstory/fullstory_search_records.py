...
async def fullstory_search_records(uid: Optional[str]=None, email: Optional[str]=None, display_name: Optional[str]=None, limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
...
async def _fs_paginate_users(url, headers, limit, timeout, verify_ssl, params):
    records = []

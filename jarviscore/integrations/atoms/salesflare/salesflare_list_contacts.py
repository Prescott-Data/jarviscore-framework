...
def salesflare_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List contacts. Official: https://api.salesflare.com/docs"""
    try:
        records, status, msg = _sf_list("/contacts", "contacts", base_url, auth_info, limit, timeout, verify_ssl)

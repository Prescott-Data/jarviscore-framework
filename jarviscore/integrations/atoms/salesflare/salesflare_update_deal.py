...
def salesflare_update_deal(auth_info: dict, deal_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp, body, status, msg = _sf_request("PUT", f"/opportunities/{deal_id}", base_url, auth_info, None, payload, timeout, verify_ssl)
        if status >= 400:

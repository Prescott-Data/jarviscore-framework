...
def salesflare_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List accounts. Official: https://api.salesflare.com/docs"""
    try:
        records, status, msg = _sf_list("/accounts", "accounts", base_url, auth_info, limit, timeout, verify_ssl)

def github_create_comment(auth_info: dict, owner: str, repo: str, issue_number: int, body: str) -> dict:
    import requests
    ...
    def _delete(p, headers=None):
        ...
        _r.raise_for_status()
        return _r.json() if _r.content else {}
    comment = _post(f"/repos/{owner}/{repo}/issues/{issue_number}/comments",
                      data={"body": body},

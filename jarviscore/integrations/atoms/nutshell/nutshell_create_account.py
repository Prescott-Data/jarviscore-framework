...
def nutshell_create_account(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Create Account via Nutshell JSON-RPC. Official: https://developers-rpc.nutshell.com/detail/class_core.html#newAccount"""
    try:
        ...
        result, status, msg = _ns_rpc(base, headers, "newAccount", {"account": payload}, timeout, verify_ssl)
        if msg != "ok":

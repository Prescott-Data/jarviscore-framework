...
async def nutshell_list_accounts(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        records, status, msg = await _ns_paginate(base, headers, 'findAccounts', params, limit, timeout, verify_ssl)

...
def nutshell_list_accounts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List Accounts via Nutshell JSON-RPC. Official: https://developers-rpc.nutshell.com/detail/class_core.html#findAccounts"""
    try:
        ...
        params = {"orderBy": "name", "orderDirection": "ASC", "stubResponses": False}
        records, status, msg = _ns_paginate(base, headers, "findAccounts", params, limit, timeout, verify_ssl)

...
def nutshell_list_contacts(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, msg = _ns_paginate(base, headers, "findContacts", params, limit, timeout, verify_ssl)

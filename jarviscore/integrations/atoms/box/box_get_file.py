...
async def box_get_file(file_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _box_get(f'{api}/files/{file_id}', headers, None, timeout, verify_ssl)

...
def box_create_folder(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _box_post_json(f"{api}/folders", headers, payload, timeout, verify_ssl)
...
# Box API v2 — https://developer.box.com/reference/post-folders/

...
def box_create_file(auth_info: dict, file_name: str, timeout: int = 30, verify_ssl: bool = True, parent_folder_id: str = "0", content: str = "", base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{BOX_UPLOAD}/files/content", headers=headers, files=files, timeout=timeout, verify=verify_ssl)
...
# Box API v2 — https://developer.box.com/reference/post-files-content/

...
def box_get_folder(auth_info: dict, folder_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _box_get(f"{api}/folders/{folder_id}", headers, None, timeout, verify_ssl)

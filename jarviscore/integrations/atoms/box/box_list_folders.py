...
def box_list_folders(auth_info: dict, timeout: int = 30, verify_ssl: bool = True, folder_id: str = "0", limit: int = 25, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _box_paginate_typed_items(url, headers, limit, timeout, verify_ssl, "folder")

...
def box_list_files(auth_info: dict, timeout: int = 30, verify_ssl: bool = True, folder_id: str = "0", limit: int = 25, base_url: str = None) -> dict:
    """List files in a folder (GET /folders/{folder_id}/items, type=file). Official: https://developer.box.com/reference/get-folders-id-items/"""
    try:
        ...
        records, status, message = _box_paginate_typed_items(url, headers, limit, timeout, verify_ssl, "file", {"fields": "id,type,name,size"})

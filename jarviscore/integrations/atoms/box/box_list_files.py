...
async def box_list_files(timeout: int=30, verify_ssl: bool=True, folder_id: str='0', limit: int=25, base_url: str=None) -> dict:
    ...
    try:
        ...
        (records, status, message) = await _box_paginate_typed_items(url, headers, limit, timeout, verify_ssl, 'file', {'fields': 'id,type,name,size'})

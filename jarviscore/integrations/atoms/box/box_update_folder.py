...
def box_update_folder(auth_info: dict, folder_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _box_put_json(f"{api}/folders/{folder_id}", headers, payload, timeout, verify_ssl)
...
# Box API v2 — https://developer.box.com/reference/put-folders-id/

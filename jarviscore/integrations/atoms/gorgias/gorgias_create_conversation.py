...
def gorgias_create_conversation(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _gorgias_post(f"{api}/tickets", headers, basic, payload, timeout, verify_ssl)

...
async def _gorgias_post(url, headers, basic, body, timeout, verify_ssl):
...
def _gorgias_ticket_id(payload, conversation_id=None):
    payload = payload if isinstance(payload, dict) else {}
    tid = conversation_id or payload.get('conversation_id') or payload.get('ticket_id') or None or None

...
def gorgias_get_conversation(auth_info: dict, conversation_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _gorgias_get(f"{api}/tickets/{conversation_id}", headers, basic, None, timeout, verify_ssl)

...
def gorgias_get_message(auth_info: dict, message_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Retrieve a Gorgias message by ID. Official: https://developers.gorgias.com/reference/get-ticket-message"""
    try:
        if not message_id:
        ...
        resp = _gorgias_get(f"{api}/messages/{message_id}", headers, basic, None, timeout, verify_ssl)

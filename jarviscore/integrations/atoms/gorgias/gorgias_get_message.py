...
async def gorgias_get_message(message_id: str, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await _gorgias_get(f'{api}/messages/{message_id}', headers, basic, None, timeout, verify_ssl)

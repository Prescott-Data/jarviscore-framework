...
def gorgias_update_message(auth_info: dict, message_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _gorgias_put(f"{api}/messages/{message_id}", headers, basic, payload, timeout, verify_ssl)

...
async def woocommerce_list_orders(limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + '/orders', headers=hdrs, params={'per_page': limit})

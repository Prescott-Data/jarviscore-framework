...
def woocommerce_list_products(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """woocommerce REST: list products. Official: https://woocommerce.github.io/woocommerce-rest-api-docs/"""
    try:
        ...
        resp = requests.get(root + "/products", headers=hdrs, auth=auth, params={'per_page': limit}, timeout=timeout, verify=verify_ssl)

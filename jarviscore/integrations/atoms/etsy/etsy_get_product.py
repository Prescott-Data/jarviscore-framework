...
def etsy_get_product(auth_info: dict, product_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        headers, auth_err = _etsy_auth(auth_info, require_oauth=False)
        if auth_err:

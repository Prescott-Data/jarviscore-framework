...
def etsy_update_order(auth_info: dict, shop_id: str, order_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(
            f"{api}/shops/{sid}/receipts/{receipt_id}",
            headers=headers,
        ...
        return {
            ...
            "message": "ok",
            "provision_ids": _etsy_provision_id(data, ("receipt_id",)),
        }

...
def etsy_update_product(auth_info: dict, shop_id: str, product_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.patch(
            f"{api}/shops/{sid}/listings/{listing_id}",
            headers=headers,

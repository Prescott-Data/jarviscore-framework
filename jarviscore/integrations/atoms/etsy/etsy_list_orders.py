...
def etsy_list_orders(auth_info: dict, shop_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _etsy_paginate(url, headers, {}, limit, timeout, verify_ssl)
        if message != "ok":

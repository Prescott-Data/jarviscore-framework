...
def liquidplanner_list_projects(auth_info: dict, workspace_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{base}/workspaces/{ws}/projects", headers=headers, timeout=timeout, verify=verify_ssl)

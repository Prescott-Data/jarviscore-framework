...
def liquidplanner_search_records(auth_info: dict, workspace_id: str, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{base}/workspaces/{ws}/treeitems", headers=headers, params=params, timeout=timeout, verify=verify_ssl)

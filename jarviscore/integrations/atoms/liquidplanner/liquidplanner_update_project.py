...
def liquidplanner_update_project(auth_info: dict, workspace_id: str, project_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(f"{base}/workspaces/{ws}/projects/{project_id}", headers=headers, json=body, timeout=timeout, verify=verify_ssl)
        try:

...
def folk_update_deal(auth_info: dict, group_id: str, deal_id: str, payload: Dict[str, Any], object_type: str = "Deals", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

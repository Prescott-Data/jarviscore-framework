...
def snapchat_ads_list_campaigns(auth_info: dict, ad_account_id: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        cap = _sc_cap(limit)
        resp = requests.get(f"{root}/adaccounts/{aid}/campaigns", headers=headers, params={"limit": cap}, timeout=timeout, verify=verify_ssl)
        ...
        records = _sc_paging(resp, data, cap, records, "campaigns")

...
def circleci_list_pipelines(auth_info: dict, project_slug: str, timeout: int = 30, verify_ssl: bool = True, limit: int = 25, base_url: str = None) -> dict:
    ...
    try:
        ...
        url = url + "/pipeline"
        records, status, message = _circleci_paginate_items(url, headers, limit, timeout, verify_ssl)

...
def circleci_get_project(auth_info: dict, project_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = _circleci_get(url, headers, None, timeout, verify_ssl)

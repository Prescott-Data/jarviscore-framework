...
def egnyte_get_file(auth_info: dict, file_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        if not file_id:
            return {
                ...
                "data_count": 0,
                "status": 400,
                "message": "file_id is required (Egnyte file path, e.g. /Shared/docs/report.pdf)",
            }

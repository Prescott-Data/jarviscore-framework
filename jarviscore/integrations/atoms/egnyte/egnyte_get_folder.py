...
def egnyte_get_folder(auth_info: dict, folder_id: str, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        if not folder_id:
            return {
                ...
                "data_count": 0,
                "status": 400,
                "message": "folder_id is required (Egnyte folder path, e.g. /Shared/Documents)",
            }

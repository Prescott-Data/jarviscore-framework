...
def egnyte_update_folder(auth_info: dict, folder_id: str, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        if not action:
            if payload.get("new_name"):
                ...
                return {
                    ...
                    "data_count": 0,
                    "status": 400,
                    "message": "payload.action is required (move, copy, rename)",
                }
        ...
        data = resp.json() if resp.text else {"path": folder_id}

...
def crisp_list_conversations(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List conversations from crisp. HTTP Basic site_id:api_key. Official: https://docs.crisp.chat/references/rest-api/v1/"""
    try:
        ...
        records, status, message = _crisp_list_conversations(api, site_id, headers, basic, limit, timeout, verify_ssl)

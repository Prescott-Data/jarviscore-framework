...
def crisp_create_message(auth_info: dict, payload: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        url = f"{api}/website/{site_id}/conversation/{session_id}/message"

...
def crisp_list_messages(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _crisp_list_messages(api, site_id, session_id, headers, basic, limit, timeout, verify_ssl)

...
def crisp_search_records(auth_info: dict, query: str, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        records, status, message = _crisp_list_conversations(api, site_id, headers, basic, limit, timeout, verify_ssl, search_query=query)

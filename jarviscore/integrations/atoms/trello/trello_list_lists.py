...
def trello_list_lists(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """Trello REST: list lists. Official: https://developer.atlassian.com/cloud/trello/rest/"""
    try:

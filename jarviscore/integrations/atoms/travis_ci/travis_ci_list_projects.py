...
def travis_ci_list_projects(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.get(f"{root}/repos", headers=headers, params={"limit": limit}, timeout=timeout, verify=verify_ssl)

...
def travis_ci_update_project(auth_info: dict, project_id: str, active: str = "true", timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.post(f"{root}/repo/{slug}/{action}", headers=headers, timeout=timeout, verify=verify_ssl)

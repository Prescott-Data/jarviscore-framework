...
async def travis_ci_list_builds(project_id: str='', limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
    ...
    try:
        ...
        resp = await nexus_call('GET', root + path, headers=headers, params={'limit': limit})

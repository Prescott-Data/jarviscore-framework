...
def posthog_list_reports(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    """List saved insights (catalog reports). Official: https://posthog.com/docs/api/product-analytics-2"""
    try:
        ...
        resp, body, status, msg = _pg_request(
            "get",
            host + f"/api/projects/{project_id}/insights/",
            auth_info,
            params=params,
            timeout=timeout,

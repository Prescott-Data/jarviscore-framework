...
def square_list_customers(auth_info: dict, limit: int = 25, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        _, data, status, msg = _sq_request("get", root + "/customers", auth_info, {"limit": _sq_cap(limit)}, timeout=timeout, verify_ssl=verify_ssl)

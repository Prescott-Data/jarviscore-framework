...
async def segment_search_records(query: str, limit: int=25, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
...
async def _sg_fetch_all(url, collection_key, limit, timeout, verify_ssl):
    cap = _sg_cap(limit)
    records = []
    next_url = url

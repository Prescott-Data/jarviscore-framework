...
def freshchat_create_message(auth_info: dict, conversation_id: str, message_parts: List[Any], actor_type: Optional[str] = None, actor_id: Optional[str] = None, user_id: Optional[str] = None, message_type: str = "normal", reply_parts: Optional[List[Any]] = None, timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:

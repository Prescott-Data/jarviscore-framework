...
async def freshchat_list_messages(conversation_id: str, limit: int=25, from_time: Optional[str]=None, timeout: int=30, verify_ssl: bool=True, base_url: str=None) -> dict:
...
async def _fc_paginate(url, headers, collection_key, limit, timeout, verify_ssl, extra_params=None):
    records = []

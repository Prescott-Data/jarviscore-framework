...
def freshchat_update_conversation(auth_info: dict, conversation_id: str, fields: Dict[str, Any], timeout: int = 30, verify_ssl: bool = True, base_url: str = None) -> dict:
    ...
    try:
        ...
        resp = requests.put(url, headers=headers, json=fields, timeout=timeout, verify=verify_ssl)
        ...
        return {
            ...
            "status": status_code,
            "message": "ok",
            "provision_ids": _fc_provision_id(data) or [str(conversation_id).strip()],
        }

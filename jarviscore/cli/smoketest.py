...
class SmokeTest:
    ...
    def print_summary(self):
        ...
        print("\n  Quick examples (single file, no infra required):")
        print("  1. AutoAgent:              python examples/calculator_agent_example.py")
        ...
        print("  4. FastAPI integration:    python examples/fastapi_integration_example.py")
        print("\n  Production examples (requires Redis: docker compose -f docker-compose.infra.yml up -d):")
        print("  5. Ex1 — Financial pipeline   (AutoAgent, autonomous):")
        print("       python examples/ex1_financial_pipeline.py")
        print("  6. Ex2 — Research network     (AutoAgent, 4-node SWIM cluster):")
        print("       python examples/ex2_synthesizer.py       # start seed first")
        print("       python examples/ex2_research_node1.py")
        print("       python examples/ex2_research_node2.py")
        print("       python examples/ex2_research_node3.py")
        print("  7. Ex3 — Support swarm        (CustomAgent, P2P, Nexus auth):")
        print("       python examples/ex3_support_swarm.py")
        print("  8. Ex4 — Content pipeline     (CustomAgent, distributed, LTM):")
        print("       python examples/ex4_content_pipeline.py")
        print("\nDocumentation:")

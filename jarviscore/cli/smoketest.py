...
class SmokeTest:
    ...
    def print_summary(self):
        ...
        print("  5. Financial pipeline   (AutoAgent, autonomous):")
        print("       python examples/financial_pipeline.py")
        print("  6. Research network     (AutoAgent, 4-node SWIM cluster):")
        print("       python examples/research_synthesizer.py  # start seed first")
        print("       python examples/research_node_1.py")
        print("       python examples/research_node_2.py")
        print("       python examples/research_node_3.py")
        print("  7. Support swarm        (CustomAgent, P2P, Nexus auth):")
        print("       python examples/support_swarm.py")
        print("  8. Content pipeline     (CustomAgent, distributed, LTM):")
        print("       python examples/content_pipeline.py")
        print("\nDocumentation:")
